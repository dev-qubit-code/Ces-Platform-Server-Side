...
public class CreateStudentInfoRequestValidator : AbstractValidator<CreateStudentInfoRequest>
{
    public CreateStudentInfoRequestValidator()
    {
        RuleFor(si => si.Name)
        ...
        .SetValidator(new CreateSourceRequestValidator());   
    }
}
